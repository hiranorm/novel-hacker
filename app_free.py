...
class App(customtkinter.CTk):
    ...
    def do_check_event(self):
        ...
        if self.task_name == "sentence_end":
...
class Analyser:
    def __init__(self):
        ...
        #self.best_model_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "models/calibration_model_cpu_20230702.ckpt")
